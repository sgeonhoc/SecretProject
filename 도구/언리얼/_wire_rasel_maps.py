...
FIX = {
    ...
    2: {  # L03 장터 뒷골목
        "exits": ["L01_Jangteo_Street", "L06_Pawnshop_Back", "L16_Abandoned_Platform"],
    ...
    6: {  # L07 전차역 승강장 — 구역 이동 허브
        "exits": ["L01_Jangteo_Street", "L06_Academy_Street", "L09_Newport_Site",
                  "L16_Tower_Lobby", "L16_Abandoned_Platform"],
        "ft": ("Tram_Jangteo", "아랫장터 승강장"),
        "lore": [("노선도", ["지하 열두 갈래.", "승강장 끝 철문 너머는 폐선 구간으로 이어진다."])],
        "gate": [("L07_OldGate", "TramKey")],
    },
    7: {  # L08 학당 앞 거리
        "exits": ["L07_Tram_Jangteo", "L09_Academy_Hall", "L08_Clinic",
                  "L07_Riverbank", "L14_Selan_Court"],
    ...
    12: {  # L13 신항 공사판
        "exits": ["L07_Tram_Jangteo", "L10_Newport_Shaft", "L15_Warehouse_Roof"],
    ...
    19: {  # L20 지하수로 갈래
        "exits": ["L16_Abandoned_Platform", "L10_Newport_Shaft", "L17_Underlayer_Gallery"],
        "lore": [("벽에 그은 표식", ["누가 먼저 지나갔는지 남긴 표식.",
                              "발굴가와 회수조가 가장 자주 마주치는 어둠."])],
    },
    20: {  # L21 아래층 회랑
        "exits": ["L20_Sewer_Junction", "L18_Ruin_Gate"],
    ...
    21: {  # L22 무너진 성문 앞뜰
        "exits": ["L17_Underlayer_Gallery", "L19_Ruin_Keep"],
